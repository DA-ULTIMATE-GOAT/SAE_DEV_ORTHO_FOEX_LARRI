...
namespace CHADventure.screen
{
    public class ScreenMenu : GameScreen
    {
        ...
        private personnage.Perso _perso = new personnage.Perso();
        ...
        public override void LoadContent()   //load le boutons,le fond
        {
        ...
        public override void Draw(GameTime gameTime) //Draw le fond, les boutons, le logo et l'engrenage
        {
